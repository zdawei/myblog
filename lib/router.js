...
module.exports = function(db) {
    ...
    return function(req, res) {
        ...
        switch(req.method) {
            case 'POST' : renderobj.renderDefault(req, res); break;
            case 'GET' : 
                switch(seps[1]) {
                    case '' :
                    case 'index.html' : renderobj.renderIndex(req, res); break;
                    case 'semantic' : renderobj.renderSementic(req, res); break;
                    default : renderobj.renderOther(req, res);
                }
            break;
            default : renderobj.renderDefault(req, res);
        }
    };
    // return function(req, res) {
    //     res.end(JSON.stringify(req.headers));return ;su
    //     switch(req.method) {
    //         case 'POST' : 
    //             var thisUrl = req.url;
